...
var reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case actionTypes.SAVE_ARTICLE:
      console.log('id', action.article.id);
      console.log('title', action.article.title);
      console.log('content', action.article.content); // const newState = Object.assign([], state.articles);     
...
//# sourceMappingURL=index.js.ccad4fb24e683def2df5.hot-update.js.map