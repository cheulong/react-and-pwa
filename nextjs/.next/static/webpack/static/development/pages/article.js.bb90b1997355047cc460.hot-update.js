  ...
  switch (action.type) {
    ...
    case actionTypes.CHANGE_ARTICLE:
      ...
      if (action.updateArticle.symbol === '-') {
        if (objIndex3 === 0) {
          objIndex3 = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_2__["default"])("objIndex3"), newState3.length - 1);
        }
        ...
        if (objIndex3 === newState3.length - 1) {
          objIndex3 = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_2__["default"])("objIndex3"), 0);
        }
...
var initStore = function initStore() {
  ...
  return Object(redux__WEBPACK_IMPORTED_MODULE_3__["createStore"])(reducer, initialState, Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_4__["composeWithDevTools"])(Object(redux__WEBPACK_IMPORTED_MODULE_3__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_5___default.a)));
};

/***/ })

})
//# sourceMappingURL=article.js.bb90b1997355047cc460.hot-update.js.map