...
var reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case actionTypes.CHANGE_ARTICLE:
      var newState3 = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, state.articles);

      var objIndex3 = newState.findIndex(function (obj) {
        return obj.id === action.article.id;
      });

      if (action.article.symbol === '-') {
        return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, state, {
...
//# sourceMappingURL=article.js.7c5a29a1cb9733d1dc5e.hot-update.js.map