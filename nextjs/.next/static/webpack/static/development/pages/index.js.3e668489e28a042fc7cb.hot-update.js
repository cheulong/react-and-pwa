...
function (_Component) {
  ...
  function ArticlesPage() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "renderArticlesList", function () {
      console.log(_this.props.articles.articles.articles.articleList); // return this.props.articles.articles.articleList.map((article,index) => <ArticleBrief index={index} selectArticle={this.selectArticle} article={article} deleteContact={this.deleteContact}/>)
    });
...
//# sourceMappingURL=index.js.3e668489e28a042fc7cb.hot-update.js.map